...
public class testCompararEmpresas {
  ...
  @Test
  public void testIndicadorOrdenSinValorCalculable() throws ServiceException, DbException // ver
                                                                                          // esto
  {
    metodologia = new MetodologiaMock();
    Indicador deuda = new Indicador("deuda", "[pasivoTotal]");
  ...
  // List<Cuenta> cuentasEmpresa1 = Arrays.asList(new Cuenta("pasivoTotal", Arrays.asList(new
  // Periodo("2017", 100))));
  // Empresa empresa1 = new Empresa("E1", cuentasEmpresa1);
  // List<Cuenta> cuentasEmpresa2 = Arrays.asList(new Cuenta("pasivoTotal", Arrays.asList(new
  // Periodo("2017", 100))), new Cuenta("activo", Arrays.asList(new Periodo("2017", 100))));
  // Empresa empresa2 = new Empresa("E2", cuentasEmpresa2);
  // metodologia.setOrdenes(Arrays.asList(new Orden(deuda,"Ascendente")));
  //
  // assertTrue(metodologia.compararEmpresas(empresa1, empresa2, "2017") == 1);

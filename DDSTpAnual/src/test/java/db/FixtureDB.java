...
//      entityManager().persist(tipoOrden2);   
  ...
  public void crearFixture()
  {
	...
	List<Periodo> periodos1 = Arrays.asList(new Periodo("2014",1000), new Periodo("2015",2000), new Periodo("2016",3000), new Periodo("2017",4000));
	List<Periodo> periodos2 = Arrays.asList(new Periodo("2014",1000), new Periodo("2015",2000), new Periodo("2016",3000), new Periodo("2017",4000));
	List<Periodo> periodos3 = Arrays.asList(new Periodo("2014",1000), new Periodo("2015",2000), new Periodo("2016",3000), new Periodo("2017",4000));
	List<Periodo> periodos4 = Arrays.asList(new Periodo("2014",1000), new Periodo("2015",2000), new Periodo("2016",3000), new Periodo("2017",4000));
    List<Cuenta> cuentas = Arrays.asList(new Cuenta("activoCorriente",periodos1), new Cuenta("activoNoCorriente",periodos2), new Cuenta("pasivoCorriente",periodos3), new Cuenta("pasivoNoCorriente",periodos4));
    Empresa facebook = new Empresa("Facebook", cuentas);
    
    List<Periodo> periodos5 =  Arrays.asList(new Periodo("2014",500), new Periodo("2015",750), new Periodo("2016",1000), new Periodo("2017",1200));
    List<Periodo> periodos6 =  Arrays.asList(new Periodo("2014",500), new Periodo("2015",750), new Periodo("2016",1000), new Periodo("2017",1200));
    List<Periodo> periodos7 =  Arrays.asList(new Periodo("2014",500), new Periodo("2015",750), new Periodo("2016",1000), new Periodo("2017",1200));
    List<Periodo> periodos8 =  Arrays.asList(new Periodo("2014",500), new Periodo("2015",750), new Periodo("2016",1000), new Periodo("2017",1200));
    List<Cuenta> cuentas2 = Arrays.asList(new Cuenta("activoCorriente",periodos5), new Cuenta("activoNoCorriente",periodos6), new Cuenta("pasivoCorriente",periodos7), new Cuenta("pasivoNoCorriente",periodos8));

...
public class FixtureMetodologiaDB extends AbstractPersistenceTest implements WithGlobalEntityManager {
  ...
  public List<Empresa> getEmpresas() {
    // empresa 1
    List<Periodo> periodos1 = Arrays.asList(new Periodo("2015", 20000), new Periodo("2016", 25000), new Periodo("2017", 50000));
    ...
    // empresa 2
    List<Periodo> periodos4 = Arrays.asList(new Periodo("2015", 30000), new Periodo("2016", 60000), new Periodo("2017", 100000));
    ...
    // empresa 3
    List<Periodo> periodos7 = Arrays.asList(new Periodo("2015", 200), new Periodo("2016", 1000));
    ...
    // empresa 4
    List<Periodo> periodos10 = Arrays.asList(new Periodo("2017", 100000));
    List<Periodo> periodos11 = Arrays.asList(new Periodo("2017", 20000));
    ...
    // empresa 5
    List<Periodo> periodos13 = Arrays.asList(new Periodo("2016", 180000), new Periodo("2017", 10000));
  ...
  private Metodologia getIndicadoresMetodologia() {
    ...
    return new Metodologia("BUFFET", Arrays.asList(new Condicion(roe, Filtro.MAYOR, 1.0), new Condicion(deuda, Filtro.MENOR, 50000.0)),
        Arrays.asList(new Orden(deuda, "Ascendente"), new Orden(roe, "Descendente")));
  }

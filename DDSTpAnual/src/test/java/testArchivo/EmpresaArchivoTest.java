...
public class EmpresaArchivoTest {
  ...
  CuentaValor empresaBusqueda1;
  CuentaValor empresaBusqueda2;

  @Before
  public void init() {
    empresaArchivo = new EmpresaArchivoImpl();

    empresaBusqueda1 = new CuentaValor("EmpresaBusqueda", "CuentaA", "2016", 200);
    empresaBusqueda2 = new CuentaValor("EmpresaBusqueda", "CuentaA", "2017", 300);
  ...
  public void testGuardarEmpresaEnExcel() throws ArchivoException {
    empresa = new CuentaValor("EmpresaArchivo", "Cuenta1", "2016", 500);
...
//    empresa = new CuentaValor("EmpresaArchivo", "Cuenta2", "2016", 500);

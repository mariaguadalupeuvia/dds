...
public class formulaParser extends Parser {
	...
	public static final int
		SUMA=1, RESTA=2, MULT=3, DIV=4, LLAVE_IZQ=5, LLAVE_DER=6, COR_IZQ=7, COR_DER=8, 
		PAREN_IZQ=9, PAREN_DER=10, INDICADOR=11, CUENTA=12, NUM=13, WS=14;
	public static final String[] tokenNames = {
		"<INVALID>", "'+'", "'-'", "'*'", "'/'", "'{'", "'}'", "'['", "']'", "'('", 
		"')'", "INDICADOR", "CUENTA", "NUM", "WS"
	};
	public static final int
		RULE_start = 0, RULE_expresion = 1, RULE_operador_mult = 2, RULE_operador_aditivo = 3, 
		RULE_operando = 4, RULE_suma = 5, RULE_resta = 6, RULE_mult = 7, RULE_div = 8, 
		RULE_indicador = 9, RULE_cuenta = 10, RULE_num = 11;
	public static final String[] ruleNames = {
		"start", "expresion", "operador_mult", "operador_aditivo", "operando", 
		"suma", "resta", "mult", "div", "indicador", "cuenta", "num"
	};
	...
	public static class StartContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof formulaListener ) ((formulaListener)listener).enterStart(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof formulaListener ) ((formulaListener)listener).exitStart(this);
		}
	}
	...
	public final StartContext start() throws RecognitionException {
		...
		try {
			...
			while (_la==SUMA || _la==RESTA) {
				{
				{
				setState(25); operador_aditivo();
				setState(26); expresion();
				}
				}
				setState(32);
				_errHandler.sync(this);
	...
	public static class ExpresionContext extends ParserRuleContext {
		...
		public Operador_multContext operador_mult(int i) {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof formulaListener ) ((formulaListener)listener).enterExpresion(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof formulaListener ) ((formulaListener)listener).exitExpresion(this);
		}
	}
	...
	public final ExpresionContext expresion() throws RecognitionException {
		...
		try {
			...
			while (_la==MULT || _la==DIV) {
				{
				{
				setState(34); operador_mult();
				setState(35); operando();
				}
				}
				setState(41);
				_errHandler.sync(this);
	...
	public static class Operador_multContext extends ParserRuleContext {
		...
		public Operador_multContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_operador_mult; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof formulaListener ) ((formulaListener)listener).enterOperador_mult(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof formulaListener ) ((formulaListener)listener).exitOperador_mult(this);
		}
	}

	public final Operador_multContext operador_mult() throws RecognitionException {
		Operador_multContext _localctx = new Operador_multContext(_ctx, getState());
	...
	public static class Operador_aditivoContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof formulaListener ) ((formulaListener)listener).enterOperador_aditivo(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof formulaListener ) ((formulaListener)listener).exitOperador_aditivo(this);
		}
	}
	...
	public static class OperandoContext extends ParserRuleContext {
		...
		public TerminalNode PAREN_IZQ() { return getToken(formulaParser.PAREN_IZQ, 0); }
		public TerminalNode PAREN_DER() { return getToken(formulaParser.PAREN_DER, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof formulaListener ) ((formulaListener)listener).enterOperando(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof formulaListener ) ((formulaListener)listener).exitOperando(this);
		}
	}
	...
	public final OperandoContext operando() throws RecognitionException {
		...
		try {
			...
			case PAREN_IZQ:
				...
				{
				setState(53); match(PAREN_IZQ);
				setState(54); start();
				setState(55); match(PAREN_DER);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public static class SumaContext extends ParserRuleContext {
		public TerminalNode SUMA() { return getToken(formulaParser.SUMA, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof formulaListener ) ((formulaListener)listener).enterSuma(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof formulaListener ) ((formulaListener)listener).exitSuma(this);
		}
	}
	...
	public static class RestaContext extends ParserRuleContext {
		public TerminalNode RESTA() { return getToken(formulaParser.RESTA, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof formulaListener ) ((formulaListener)listener).enterResta(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof formulaListener ) ((formulaListener)listener).exitResta(this);
		}
	}
	...
	public static class MultContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof formulaListener ) ((formulaListener)listener).enterMult(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof formulaListener ) ((formulaListener)listener).exitMult(this);
		}
	}
	...
	public static class DivContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof formulaListener ) ((formulaListener)listener).enterDiv(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof formulaListener ) ((formulaListener)listener).exitDiv(this);
		}
	}
	...
	public static class IndicadorContext extends ParserRuleContext {
		...
		public TerminalNode INDICADOR() { return getToken(formulaParser.INDICADOR, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof formulaListener ) ((formulaListener)listener).enterIndicador(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof formulaListener ) ((formulaListener)listener).exitIndicador(this);
		}
	}
	...
	public final IndicadorContext indicador() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(67); ((IndicadorContext)_localctx).INDICADOR = match(INDICADOR);
			indicadores.add((((IndicadorContext)_localctx).INDICADOR!=null?((IndicadorContext)_localctx).INDICADOR.getText():null).substring(1,(((IndicadorContext)_localctx).INDICADOR!=null?((IndicadorContext)_localctx).INDICADOR.getText():null).length() - 2));
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static class CuentaContext extends ParserRuleContext {
		public Token CUENTA;
		public TerminalNode CUENTA() { return getToken(formulaParser.CUENTA, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof formulaListener ) ((formulaListener)listener).enterCuenta(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof formulaListener ) ((formulaListener)listener).exitCuenta(this);
		}
	}
	...
	public final CuentaContext cuenta() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(70); ((CuentaContext)_localctx).CUENTA = match(CUENTA);
			cuentas.add((((CuentaContext)_localctx).CUENTA!=null?((CuentaContext)_localctx).CUENTA.getText():null).substring(1,(((CuentaContext)_localctx).CUENTA!=null?((CuentaContext)_localctx).CUENTA.getText():null).length() - 2));
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;

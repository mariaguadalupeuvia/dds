...
public class EmpresasRepositorio implements WithGlobalEntityManager, TransactionalOps {

  public static EmpresasRepositorio instancia = new EmpresasRepositorio();
  ...
  public Empresa obtenerEmpresa(String nombre) {
    Empresa empresa;
    try {
      empresa = entityManager().createQuery("from Empresa where nombre = :nombre", Empresa.class).setParameter("nombre", nombre)
          .getSingleResult();

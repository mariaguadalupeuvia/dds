...
public class Paleta {
	...
	{
		return new Color(41, 102, 40);
	}
	public static Color colorMedioBajo()
	{
		return new Color(81, 127, 80);
	}
	public static Color colorMedio()
	{
		return new Color(121, 152, 120);
	}
	public static Color colorMedioAlto()
	{
		return new Color(101, 182, 100);
	}
	public static Color colorAlto()
	{
		return new Color(71, 142, 70);
	}
	
	
	public static Color fuenteAlta()
	{
		return new Color(255, 255, 255);
	}
}
